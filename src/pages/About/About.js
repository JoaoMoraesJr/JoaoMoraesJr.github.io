...
function About() {
    ...
    return(
        <div className="about-page page-margin">
            <div className="about-headline stylized-container">
                ...
                <div>
                    <h1 className="about-title" style={{marginBottom: 40}}>{about?.title}</h1>
            ...
            <div className="section align-left stylized-container">
                <h2>What I do</h2>
            ...
            <div className="align-left page-padding">
                <div className='about-subtitle stylized-container' style={{padding: 25}}>
                    <h2>My Experience</h2>
                    <ul className="about-list secondary-stylized-container">
                    ...
                    <ul className="about-list secondary-stylized-container">
                        ...
                        <li className="timeline-bullet">
                            ...
                            <div className="timeline-description">
                                <h4>Undergraduate Student Researcher</h4>
                                <span className="timeline-date">Ago 2018 - Ago 2019</span>
                            </div>
                        </li>
                    </ul>
                ...
                <div className='about-subtitle stylized-container' style={{padding: 25}}>
                    ...
                    <ul className="about-list secondary-stylized-container">
                        <div className="timeline-item">
                            ...
                            <div className="timeline-description">
                                <h3>Toastmasters - Vice President of Public Relationships</h3>
                    ...
                    <ul className="about-list secondary-stylized-container">
                        <div className="timeline-item">
                            ...
                            <div className="timeline-description">
                                <h3>Brazilians in Technical Interviews - Mentor</h3>
                ...
                <div className='about-subtitle stylized-container' style={{padding: 25}}>
                    ...
                    <div className="languages-section">
                        <div className="languages-col secondary-stylized-container">
                            <h3>I can code in many languages</h3>
                            <span>Go</span>
                            <span>Python</span>
                        ...
                        <div className="languages-col secondary-stylized-container">
                            <h3>And comunicate in some others</h3>
